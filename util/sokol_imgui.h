...
// simgui_context: an opaque handle to a separate copy of the sokol-imgui
// state. The caller provides the memory. sokol-imgui does not detect a reused
// or an uninitialized handle.
//
// simgui_set_context() selects the context for the next calls on this thread.
// Use one context on one thread at a time.
//
// simgui_setup() selects a default context if no context is current.
// simgui_shutdown() releases that default context, but keeps a context from
// simgui_init_context().
typedef struct simgui_context_s* simgui_context;

SOKOL_IMGUI_API_DECL size_t simgui_context_size(void);
SOKOL_IMGUI_API_DECL simgui_context simgui_init_context(void* ptr);
...
SOKOL_IMGUI_API_DECL void simgui_uninit_context(simgui_context ctx);
#endif
...
typedef struct {
    ...
    simgui_desc_t desc;
    float cur_dpi_scale;
    float gamma;            // gamma correction value to counter SRGB mapping (1.0 or 2.2)
    size_t vbuf_size;
    size_t ibuf_size;
    sg_buffer vbuf;
    sg_buffer ibuf;
...
#if defined(SOKOL_IMGUI_MULTI_CONTEXT)
// `_simgui_current` points at the current context state. `_simgui` resolves to it, so
// all state access goes through the current context.
//
// A thread must call simgui_set_context() before its first simgui call, unless it uses
// the default context. Until then `_simgui_current` points at `_simgui_null_ctx`: a
// shared context that is always invalid (`.init_cookie == 0`), and a real object, so
// `_simgui` stays dereferenceable.
static _simgui_state_t _simgui_null_ctx;
#if !defined(SOKOL_INSTANCE_NO_DEFAULT_CONTEXT)
// storage for the default context
static _simgui_state_t _simgui_default_ctx;
#endif
...
#if defined(__cplusplus)
    #define _SIMGUI_ALIGNOF(T) alignof(T)
#elif defined(_MSC_VER) && !defined(__clang__)
    #define _SIMGUI_ALIGNOF(T) __alignof(T)
#else
    #define _SIMGUI_ALIGNOF(T) _Alignof(T)
#endif
SOKOL_API_IMPL size_t simgui_context_size(void) {
    return sizeof(_simgui_state_t);
}
SOKOL_API_IMPL simgui_context simgui_init_context(void* ptr) {
    SOKOL_ASSERT(ptr);
    SOKOL_ASSERT(0 == ((uintptr_t)ptr % _SIMGUI_ALIGNOF(_simgui_state_t)));
    memset(ptr, 0, sizeof(_simgui_state_t));
    return (simgui_context)ptr;
}
...
SOKOL_API_IMPL void simgui_uninit_context(simgui_context ctx) {
    if (0 == ctx) {
        return;
    }
...
static const uint8_t _simgui_shd_vs_source_glsl410[430] = {
...
static const uint8_t _simgui_shd_vs_source_glsl300es[391] = {
...
static const uint8_t _simgui_shd_vs_bytecode_metal_macos[3338] = {
...
static const uint8_t _simgui_shd_vs_bytecode_metal_ios[3610] = {
...
static const uint8_t _simgui_shd_vs_source_metal_sim[739] = {
...
static const uint8_t _simgui_shd_vs_bytecode_hlsl4[1016] = {
...
static const uint8_t _simgui_shd_vs_source_wgsl[1076] = {
...
static const uint8_t _simgui_shd_vs_bytecode_spirv_vk[1840] = {
    0x03,0x02,0x23,0x07,0x00,0x04,0x01,0x00,0x0b,0x00,0x08,0x00,0x40,0x00,0x00,0x00,
    ...
    0x64,0x69,0x73,0x70,0x5f,0x73,0x69,0x7a,0x65,0x00,0x00,0x00,0x06,0x00,0x05,0x00,
    0x14,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x67,0x61,0x6d,0x6d,0x61,0x00,0x00,0x00,
    0x05,0x00,0x03,0x00,0x16,0x00,0x00,0x00,0x5f,0x32,0x32,0x00,0x05,0x00,0x03,0x00,
    0x29,0x00,0x00,0x00,0x75,0x76,0x00,0x00,0x05,0x00,0x05,0x00,0x2a,0x00,0x00,0x00,
    0x74,0x65,0x78,0x63,0x6f,0x6f,0x72,0x64,0x30,0x00,0x00,0x00,0x05,0x00,0x04,0x00,
    0x2c,0x00,0x00,0x00,0x63,0x6f,0x6c,0x6f,0x72,0x00,0x00,0x00,0x05,0x00,0x04,0x00,
    0x2e,0x00,0x00,0x00,0x63,0x6f,0x6c,0x6f,0x72,0x30,0x00,0x00,0x47,0x00,0x03,0x00,
    ...
    0x1e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x47,0x00,0x03,0x00,0x14,0x00,0x00,0x00,
    0x02,0x00,0x00,0x00,0x48,0x00,0x05,0x00,0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    0x29,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x47,0x00,0x04,0x00,
    ...
    0x2e,0x00,0x00,0x00,0x1e,0x00,0x00,0x00,0x02,0x00,0x00,0x00,0x13,0x00,0x02,0x00,
    ...
    0x01,0x00,0x00,0x00,0x1e,0x00,0x04,0x00,0x14,0x00,0x00,0x00,0x10,0x00,0x00,0x00,
    ...
    ,
    ...
    ,
};
...
SOKOL_API_IMPL void simgui_setup(const simgui_desc_t* desc) {
    ...
    if (&_simgui_null_ctx == _simgui_current) {
        simgui_set_context(simgui_init_context(&_simgui_default_ctx));
    ...
    // figure out correct gamma correction value (1.0 when rendering
    // into non-SRGB render target, or 2.2 when rendering into SRGB target)
    ...
    vb_desc.size = _simgui.vbuf_size;
    ...
    ib_desc.size = _simgui.ibuf_size;
...
#if defined(SOKOL_IMGUI_MULTI_CONTEXT) && !defined(SOKOL_INSTANCE_NO_DEFAULT_CONTEXT)
    // release only the default context from simgui_setup()
    if (_simgui_current_ctx_owned) {
        simgui_uninit_context((simgui_context)_simgui_current);
    }
#endif
}
...
SOKOL_API_IMPL void simgui_render(void) {
    ...
    for (int cl_index = 0; cl_index < draw_data->CmdLists.Size; cl_index++, cmd_list_count++) {
        ...
        if (((vb_offset + vtx_size) > _simgui.vbuf_size) ||
            ((ib_offset + idx_size) > _simgui.ibuf_size))
        {
            _SIMGUI_ERROR(BUFFER_OVERFLOW);
            break;
        }
        if (vtx_size > 0) {
            write_desc.dst.buffer = _simgui.vbuf;
            write_desc.dst.offset = vb_offset;
        ...
        if (idx_size > 0) {
            ...
            write_desc.dst.offset = ib_offset;
